...
_ADAPTER_MODULES: dict[str, str] = {
    "claude": "acreta.adapters.claude",
    "codex": "acreta.adapters.codex",
    "opencode": "acreta.adapters.opencode",
    "cursor": "acreta.adapters.cursor",
}

_AUTO_SEED_PLATFORMS = ("claude", "codex", "opencode")
...
def connect_platform(path: Path, name: str, custom_path: str | None = None) -> dict[str, Any]:
