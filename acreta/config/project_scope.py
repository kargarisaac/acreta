"""Project/global data directory resolution for Acreta memory scope modes."""
...
if __name__ == "__main__":
    ...
    resolved = resolve_data_dirs(
        ...
        global_data_dir=Path.home() / ".acreta",
        repo_path=cwd,
    )
    assert resolved.global_data_dir == (Path.home() / ".acreta").resolve()
