# Simple Coding Rules (Acreta)

This file defines general coding rules for Acreta.
...
## 5) Config from env, explicit and simple

Use environment variables for runtime provider/config choices.
